var Scratch = (function () {
    ...
    Scratch.prototype.init = function () {
        ...
        this.ctx.font="bold 50px/50px Arial";
        this.ctx.textAlign="center";
        this.ctx.textBaseLine="middle";
        this.ctx.fillStyle = "";
        this.ctx.fillText("刮奖区", this.canvas.width/2, this.canvas.height/2);
    ...
    Scratch.prototype.setBackground = function () {
        ...
        this.image.onload = function () {
            ...
            // Draw image
            _this.ctx.drawImage(this, 0, 0, _this.zone.width, _this.zone.height);
    ...
    Scratch.prototype.scratch = function (e) {
        try {
            ...
            var y = position.y - this.zone.top + 60;
            var i = 0;
